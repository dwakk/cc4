...
public class Main {
	private static final String OCAML_CLI_DIR = "crud";
	private static final String PERSISTENCE_ASSISTANT  = "main";

	public static void main(String[] args) {
		String projectPath = System.getProperty("user.dir");
		String ocamlCLIpath = projectPath + File.separator + OCAML_CLI_DIR;
